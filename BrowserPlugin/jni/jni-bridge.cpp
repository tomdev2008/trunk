...
EXPORT jint JNI_OnLoad(JavaVM* vm, void* reserved) {
    ...
    jclass resultReceiverCls = env->FindClass("com/android/sampleplugin/PaintSurface");
        if (resultReceiverCls == NULL)
            return -1;

        env->RegisterNatives(resultReceiverCls, gPaintSurfaceMethods, NELEM(gPaintSurfaceMethods));
